...
export const TEMPLATE_IMPORTED_MMSZANDO = {
  "zh-tw": `{{drink_product}}的專業照片。在{{drink_background}}上。{{drink_product}}{{drink_action}}。橙汁在罐周圍旋轉。罐體上的高光和橙子在背景上的陰影。{{drink_camera_angle}}，使用DSLR 35mm 2.8拍攝`,
...
export const TEMPLATE_SKINCARE_FANTASY_AD = {
  "zh-tw": `超現實奢華護膚品廣告照片，傾斜的巨大{{skincare_product}}漂浮在柔軟白雲上方，瓶身為{{skincare_color}}的玻璃材質，瓶內產品呈新鮮凝結水珠狀，瓶身在空中微微傾斜。一位時尚年輕女性面容平靜自然，{{fantasy_character_pose}}，身穿{{fantasy_dress_style}}，裙襬隨風輕柔飄動。{{fantasy_floating_elements}}在空中漂浮。夢幻奇妙的護膚品廣告美學，{{fantasy_sky_background}}背景，玻璃瓶身呈現光澤反射，超寫實商業產品攝影，柔和電影級陽光帶來清晰高光，使用佳能EOS R5拍攝，50mm f/1.8鏡頭，{{pastel_color_palette}}調色板`,
