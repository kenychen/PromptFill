...
export const TEMPLATE_IMPORTED_MMQC6OK1 = {
  "zh-tw": `一張照片，展示極度擁擠的{{location}}車廂內部，人們站著排成一排的全身照。一隻巨大的、可愛的{{character_type}}，正看著鏡頭，乘坐著穿過{{city_name}}城市交通的地鐵。`,
...
export const TEMPLATE_IMPORTED_MMRP53JL = {
  "zh-tw": `建立一張3D {{art_style}} 風格的插畫。畫面中是一個全身 {{character_type}} 從 Instagram 帖子的邊框中探出頭來，彷彿她是一個社交媒體角色。背景是 {{background_color}}，採用神經線條畫風格。女孩快樂、甜美，大眼睛，帶著微笑。邊框中顯示使用者名：{{profile_name}}。新增 Instagram 風格的“點贊”、“評論”和“發送”圖標。一隻手託著邊框。3:4 格式`,
...
,
  {
    ...
    name: { "zh-tw": "地鐵玩偶裝扮", en: "Subway Rabbit Costume" },
