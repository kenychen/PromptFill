...
export const INITIAL_BANKS = {
  ...
  editorial_cover_theme: {
    label: { "zh-tw": "封面主題", en: "Cover Theme" },
    category: "other",
    options: [
      { "zh-tw": "前端部署工程師", en: "Front-end Deployment Engineer" },
      { "zh-tw": "提示詞工程師", en: "Prompt Engineer" },
      { "zh-tw": "獨立開發者", en: "Indie Developer" },
      { "zh-tw": "AI 產品經理", en: "AI Product Manager" },
      { "zh-tw": "遠程辦公", en: "Remote Work" },
      { "zh-tw": "知識庫", en: "Knowledge Base" },
      { "zh-tw": "數位遊民", en: "Digital Nomad" },
      { "zh-tw": "開源維護者", en: "Open Source Maintainer" },
      { "zh-tw": "資料隱私", en: "Data Privacy" },
      { "zh-tw": "創作者經濟", en: "Creator Economy" },
      { "zh-tw": "演算法推薦", en: "Algorithmic Feeds" },
      { "zh-tw": "螢幕疲勞", en: "Screen Fatigue" },
      { "zh-tw": "程式碼審查", en: "Code Review" },
      { "zh-tw": "側邊專案", en: "Side Project" }
    ]
  },

  editorial_cover_subtitle: {
    label: { "zh-tw": "封面副標題", en: "Cover Subtitle" },
    category: "other",
    options: [
      { "zh-tw": "自動判斷（可留空）", en: "Auto (leave empty if unneeded)" },
      { "zh-tw": "從零開始，掌握核心技能", en: "From zero, master the core skills" },
      { "zh-tw": "人在用科技做什麼", en: "What people do with technology" },
      { "zh-tw": "一次時代錯位", en: "One anachronism" },
      { "zh-tw": "從想法到上線", en: "From idea to launch" },
      { "zh-tw": "屬於今天的獨立雜誌", en: "An independent magazine of today" },
      { "zh-tw": "把抽象變成可觸碰的事", en: "Make the abstract tangible" },
      { "zh-tw": "今天才會發生的話題", en: "A topic that could only happen today" }
    ]
  },

  editorial_cover_ratio: {
    label: { "zh-tw": "封面畫幅", en: "Cover Ratio" },
    category: "visual",
    options: [
      { "zh-tw": "自動", en: "Auto" },
      { "zh-tw": "3:4", en: "3:4" },
  ...
  editorial_cover_cast: {
    label: { "zh-tw": "人物設定", en: "Cast" },
    category: "character",
    options: [
      { "zh-tw": "自動判斷", en: "Auto" },
      { "zh-tw": "女性", en: "Female" },
      { "zh-tw": "男性", en: "Male" },
      { "zh-tw": "一男一女", en: "One woman and one man" },
      { "zh-tw": "雙女性", en: "Two women" },
      { "zh-tw": "雙男性", en: "Two men" },
      { "zh-tw": "工程師", en: "Engineer" },
      { "zh-tw": "編輯 / 學者", en: "Editor / Scholar" },
      { "zh-tw": "工作搭檔", en: "Work partners" },
      { "zh-tw": "三人以內小群像", en: "Small group of three or fewer" }
    ]
  },

  editorial_cover_emotion: {
    label: { "zh-tw": "情感傾向", en: "Emotional Tone" },
    category: "visual",
    options: [
      { "zh-tw": "自動判斷", en: "Auto" },
      { "zh-tw": "溫暖", en: "Warm" },
      { "zh-tw": "治癒", en: "Healing" },
      { "zh-tw": "理性", en: "Rational" },
      { "zh-tw": "剋制", en: "Restrained" },
      { "zh-tw": "浪漫", en: "Romantic" },
      { "zh-tw": "神秘", en: "Mysterious" },
      { "zh-tw": "怪誕", en: "Uncanny" },
      { "zh-tw": "冷峻", en: "Austere" },
      { "zh-tw": "幽默", en: "Humorous" },
      { "zh-tw": "戲劇化", en: "Dramatic" }
    ]
  },

  memory_core: {
    label: { "zh-tw": "記憶核心", en: "Memory Core" },
    category: "visual",
    options: [
      { "zh-tw": "自動判斷", en: "Auto" },
      { "zh-tw": "自動提煉物件、人物關係、動作、空間或光線", en: "Auto-extract objects, relations, action, space, or light" },
      { "zh-tw": "窗邊暮色", en: "Dusk by the window" },
      { "zh-tw": "室內與窗外的冷暖交界", en: "Warm interior meeting cool outdoor light" },
      { "zh-tw": "桌面上的生活痕跡", en: "Traces of life on the table" },
      { "zh-tw": "獨處時的光線", en: "Light in a moment of solitude" },
      { "zh-tw": "物件與空間的距離", en: "Distance between objects and space" },
      { "zh-tw": "天氣滲進室內", en: "Weather seeping indoors" },
      { "zh-tw": "人物未在場的生活現場", en: "A lived scene with no one present" },
      { "zh-tw": "旅途中的片刻停頓", en: "A pause on the road" }
    ]
  },

  preserved_elements: {
    label: { "zh-tw": "重點保留", en: "Preserved Elements" },
    category: "visual",
    options: [
      { "zh-tw": "主要物件、空間結構與色彩關係", en: "Key objects, spatial structure, and color relationships" },
      { "zh-tw": "窗框、桌面與窗外景色", en: "Window frame, tabletop, and the view outside" },
      { "zh-tw": "前景物件與背景光線", en: "Foreground objects and background light" },
      { "zh-tw": "傢俱佈局與強調色", en: "Furniture layout and the accent color" },
      { "zh-tw": "人物輪廓與環境色溫", en: "Figure silhouette and environmental color temperature" },
      { "zh-tw": "冷色窗外與暖色室內", en: "Cool exterior against a warm interior" },
      { "zh-tw": "植物、桌面與建築輪廓", en: "Plant, tabletop, and architectural outline" }
    ]
  },

  abstraction_level: {
    label: { "zh-tw": "抽象程度", en: "Abstraction Level" },
    category: "visual",
    options: [
      { "zh-tw": "高度抽象但關係可辨", en: "Highly abstract, relationships still readable" },
      { "zh-tw": "中度抽象，主體仍然清晰", en: "Moderate abstraction, subject still clear" },
      { "zh-tw": "高度抽象，僅保留動作與關係", en: "High abstraction, keep only action and relations" },
      { "zh-tw": "極度抽象，只留下色彩與空間節奏", en: "Extreme abstraction, only color and spatial rhythm remain" },
      { "zh-tw": "局部抽象，人物比環境更清晰", en: "Partial abstraction, figure clearer than environment" },
      { "zh-tw": "局部抽象，環境比人物更清晰", en: "Partial abstraction, environment clearer than figure" }
    ]
  },

  block_language: {
    label: { "zh-tw": "色塊語言", en: "Block Language" },
    category: "visual",
    options: [
      { "zh-tw": "柔和大色域與少量銳利幾何切面", en: "Soft large color fields with a few sharp geometric cuts" },
      { "zh-tw": "柔和、圓潤、相互覆蓋的有機色塊", en: "Soft, rounded, overlapping organic blocks" },
      { "zh-tw": "大面積平塗色塊與銳利幾何切面", en: "Large flat fields with sharp geometric facets" },
      { "zh-tw": "具有紙張撕裂邊緣的不規則色塊", en: "Irregular blocks with torn-paper edges" },
      { "zh-tw": "半透明色層與輕微套印錯位", en: "Translucent layers with slight print misregistration" },
      { "zh-tw": "極少量巨大色塊與細小視覺錨點", en: "A few huge blocks with tiny visual anchors" },
      { "zh-tw": "流動色域與突然中斷的硬邊", en: "Flowing fields interrupted by sudden hard edges" },
      { "zh-tw": "類似絲網印刷的有限色塊", en: "Limited blocks like screen printing" },
      { "zh-tw": "類似剪紙拼貼的扁平色塊", en: "Flat blocks like paper-cut collage" }
    ]
  },

  color_strategy: {
    label: { "zh-tw": "色彩策略", en: "Color Strategy" },
    category: "visual",
    options: [
      { "zh-tw": "從原圖提取2–4種低飽和主色，並保留一個鮮明強調色", en: "Pull 2–4 low-saturation primaries from the photo, keep one vivid accent" },
      { "zh-tw": "從原圖提取2–4種低飽和專色", en: "Extract 2–4 low-saturation spot colors from the photo" },
      { "zh-tw": "從原圖提取2–4種主色並降低飽和度", en: "Extract 2–4 main colors from the photo and desaturate them" },
      { "zh-tw": "保留原圖冷暖關係，減少中間色", en: "Keep the photo's warm/cool split, reduce midtones" },
      { "zh-tw": "單色體系加一個高飽和強調色", en: "A monochrome system plus one high-saturation accent" },
      { "zh-tw": "兩組互補色形成視覺張力", en: "Two complementary pairs for visual tension" },
      { "zh-tw": "使用偏灰的大地色與少量亮色", en: "Grayed earth tones with a little bright color" },
      { "zh-tw": "將原圖轉換成低飽和復古印刷色", en: "Convert the photo into low-saturation vintage print colors" },
      { "zh-tw": "保留最鮮明的服裝顏色，其餘轉為中性色", en: "Keep the strongest garment color, turn the rest neutral" },
      { "zh-tw": "根據照片情緒重新組織色彩，但不改變冷暖基調", en: "Reorganize color by mood without changing the warm/cool key" }
    ]
  },

  aspect_ratio: {
    label: { "zh-tw": "輸出比例", en: "Aspect Ratio" },
    category: "visual",
    options: [
      { "zh-tw": "3:4", en: "3:4" },
      { "zh-tw": "4:5", en: "4:5" },
  ...
  main_text: {
    label: { "zh-tw": "主文字", en: "Main Text" },
    category: "other",
    options: [
      { "zh-tw": "根據原圖內容生成2–6字的簡約短語", en: "Generate a 2–6 character spare phrase from the photo" },
      { "zh-tw": "窗邊", en: "Windowside" },
      { "zh-tw": "暮色", en: "Dusk" },
      { "zh-tw": "室內", en: "Indoors" },
      { "zh-tw": "停頓", en: "Pause" },
      { "zh-tw": "留白", en: "Whitespace" },
      { "zh-tw": "不寫主文字", en: "No main text" }
    ]
  },

  supporting_text: {
    label: { "zh-tw": "輔助文字", en: "Supporting Text" },
    category: "other",
    options: [
      { "zh-tw": "根據畫面生成一句剋制、具體的記憶描述，也可以省略", en: "A restrained, specific memory line from the picture, or omit" },
      { "zh-tw": "藍色落進室內", en: "Blue falls indoors" },
      { "zh-tw": "光線停在桌面上", en: "Light rests on the table" },
      { "zh-tw": "窗外還未完全天黑", en: "Outside is not fully dark yet" },
      { "zh-tw": "省略輔助文字", en: "Omit supporting text" }
    ]
  },

  text_language: {
    label: { "zh-tw": "文字語言", en: "Text Language" },
    category: "other",
    options: [
      { "zh-tw": "跟隨使用者使用的語言", en: "Follow the user's language" },
      { "zh-tw": "優先英文；若圖像具有明確地域語言，則使用對應語言", en: "English first; use a regional language if the image clearly belongs to one" },
      { "zh-tw": "中文", en: "Chinese" },
      { "zh-tw": "英文", en: "English" },
      { "zh-tw": "中英對照", en: "Chinese and English" }
    ]
  },

  display_mode: {
    label: { "zh-tw": "呈現方式", en: "Display Mode" },
    category: "visual",
    options: [
      { "zh-tw": "原圖在上，抽象色塊轉譯在下", en: "Photo on top, abstract translation below" },
      { "zh-tw": "抽象作品為主體，原圖以膠帶固定在角落", en: "Abstract as the main work, photo taped in a corner" },
      { "zh-tw": "只展示抽象轉譯結果", en: "Show only the abstract translation" },
      { "zh-tw": "原圖與轉譯結果左右對照", en: "Photo and translation side by side" },
      { "zh-tw": "原圖作為小型檔案縮略圖嵌入留白區", en: "Photo as a small archival thumbnail in the white space" },
      { "zh-tw": "抽象色塊局部越過邊界，與原圖發生連線", en: "Abstract blocks cross the boundary and meet the photo" }
    ]
  },

  exhibition_theme: {
    label: { "zh-tw": "展覽主題", en: "Exhibition Theme" },
    category: "other",
    options: [
      { "zh-tw": "根據照片生成2–8字的含蓄主題", en: "A 2–8 character understated theme from the photo" },
      { "zh-tw": "靜置的聲音", en: "Sound at rest" },
      { "zh-tw": "窗邊", en: "Windowside" },
      { "zh-tw": "未完成的傍晚", en: "An unfinished evening" },
      { "zh-tw": "牆上的樂器", en: "Instruments on the wall" },
      { "zh-tw": "室內光線", en: "Indoor light" },
      { "zh-tw": "停放的日常", en: "Daily life at rest" },
      { "zh-tw": "負形記憶", en: "Negative-space memory" }
    ]
  },

  description: {
    label: { "zh-tw": "說明文字", en: "Caption" },
    category: "other",
    options: [
      { "zh-tw": "根據畫面真實內容生成一句簡短描述", en: "One short caption from what the picture actually shows" },
      { "zh-tw": "絃樂器、百葉窗與傍晚光線", en: "String instruments, blinds, and evening light" },
      { "zh-tw": "窗框、桌面與窗外景色", en: "Window frame, tabletop, and the view outside" },
      { "zh-tw": "物件停在原處", en: "Objects left where they were" },
      { "zh-tw": "牆上的輪廓與前景的暗部", en: "Wall silhouettes and a dark foreground" },
      { "zh-tw": "省略說明文字", en: "Omit the caption" }
    ]
  },

  translation_mode: {
    label: { "zh-tw": "轉譯方式", en: "Translation Mode" },
    category: "visual",
    options: [
      { "zh-tw": "抽象重製", en: "Abstract remake" },
      { "zh-tw": "剪影重組", en: "Silhouette recomposition" },
      { "zh-tw": "專色套印", en: "Spot-color overprint" },
      { "zh-tw": "幾何切片", en: "Geometric slices" },
      { "zh-tw": "負形與缺失", en: "Negative space and omission" },
      { "zh-tw": "排線與網點", en: "Hatching and halftone" },
      { "zh-tw": "比例放大局部", en: "Scaled-up fragments" },
      { "zh-tw": "概念化重繪", en: "Conceptual redraw" }
    ]
  },

  translation_focus: {
    label: { "zh-tw": "轉譯重點", en: "Translation Focus" },
    category: "visual",
    options: [
      { "zh-tw": "自動選擇3–5個最具識別度的元素", en: "Auto-select 3–5 of the most recognizable elements" },
      { "zh-tw": "輪廓、方向與色彩", en: "Contour, direction, and color" },
      { "zh-tw": "物件剪影與空間節奏", en: "Object silhouettes and spatial rhythm" },
      { "zh-tw": "材質、比例與負形", en: "Material, proportion, and negative space" },
      { "zh-tw": "光線方向與主色塊", en: "Light direction and main color fields" },
      { "zh-tw": "前景暗部與牆上物件", en: "Foreground darks and objects on the wall" }
    ]
  },

  serial_code: {
    label: { "zh-tw": "抽象編號", en: "Serial Code" },
    category: "other",
    options: [
      { "zh-tw": "NO. 02", en: "NO. 02" },
      { "zh-tw": "NO. 01", en: "NO. 01" },
      { "zh-tw": "NO. 03", en: "NO. 03" },
      { "zh-tw": "NO. 07", en: "NO. 07" },
      { "zh-tw": "NO. 11", en: "NO. 11" },
      { "zh-tw": "ARCHIVE 04", en: "ARCHIVE 04" },
      { "zh-tw": "不顯示編號", en: "No serial" }
    ]
  },

  album_title: {
    label: { "zh-tw": "專輯名稱", en: "Album Title" },
    category: "other",
    options: [
      { "zh-tw": "根據圖像核心生成2–5個英文單詞", en: "2–5 English words from the image’s core" },
      { "zh-tw": "VERMILION RAIN", en: "VERMILION RAIN" },
      { "zh-tw": "FOREST STUDY", en: "FOREST STUDY" },
      { "zh-tw": "BLUE HOUR", en: "BLUE HOUR" },
      { "zh-tw": "WINDOW LIGHT", en: "WINDOW LIGHT" },
      { "zh-tw": "STATIC SOUND", en: "STATIC SOUND" },
      { "zh-tw": "EVENING ROOM", en: "EVENING ROOM" }
    ]
  },

  album_note: {
    label: { "zh-tw": "註釋文字", en: "Album Note" },
    category: "other",
    options: [
      { "zh-tw": "根據畫面生成一句簡短英文描述", en: "One short English line from the picture" },
      { "zh-tw": "雨の鳥居", en: "雨の鳥居" },
      { "zh-tw": "FOREST STUDY 01", en: "FOREST STUDY 01" },
      { "zh-tw": "Rain on vermilion timber", en: "Rain on vermilion timber" },
      { "zh-tw": "Indoor light at rest", en: "Indoor light at rest" },
      { "zh-tw": "省略註釋", en: "Omit the note" }
    ]
  },

  catalog_code: {
    label: { "zh-tw": "目錄編號", en: "Catalog Code" },
    category: "other",
    options: [
      { "zh-tw": "自動生成簡潔的虛構編號", en: "Auto-generate a short fictional catalog code" },
      { "zh-tw": "FOREST STUDY 01", en: "FOREST STUDY 01" },
      { "zh-tw": "ARC-02", en: "ARC-02" },
      { "zh-tw": "CAT 1973", en: "CAT 1973" },
      { "zh-tw": "SIDE A / 01", en: "SIDE A / 01" },
      { "zh-tw": "VM-04", en: "VM-04" },
      { "zh-tw": "不顯示編號", en: "No catalog code" }
    ]
  },

  cover_style: {
    label: { "zh-tw": "封面風格", en: "Cover Style" },
    category: "visual",
    options: [
      { "zh-tw": "70年代現代主義專輯設計", en: "1970s modernist album design" },
      { "zh-tw": "絲網印刷專色幾何", en: "Screen-print spot-color geometry" },
      { "zh-tw": "攝影拼貼與局部剪影", en: "Photo collage with partial silhouettes" },
      { "zh-tw": "瑞士國際主義排版", en: "Swiss international typography" },
      { "zh-tw": "日本現代主義海報", en: "Japanese modernist poster" },
      { "zh-tw": "光學折射與疊印", en: "Optical refraction and overprint" },
      { "zh-tw": "極簡單色加強調色", en: "Minimal monochrome plus one accent" }
    ]
  }
};
...
export const INITIAL_DEFAULTS = {
  ...
  editorial_cover_theme: { "zh-tw": "前端部署工程師", en: "Front-end Deployment Engineer" },
  editorial_cover_subtitle: { "zh-tw": "從零開始，掌握核心技能", en: "From zero, master the core skills" },
  editorial_cover_ratio: { "zh-tw": "3:4", en: "3:4" },
  editorial_cover_cast: { "zh-tw": "男性", en: "Male" },
  editorial_cover_emotion: { "zh-tw": "理性", en: "Rational" },
  memory_core: { "zh-tw": "自動判斷", en: "Auto" },
  preserved_elements: { "zh-tw": "主要物件、空間結構與色彩關係", en: "Key objects, spatial structure, and color relationships" },
  abstraction_level: { "zh-tw": "高度抽象但關係可辨", en: "Highly abstract, relationships still readable" },
  block_language: { "zh-tw": "柔和大色域與少量銳利幾何切面", en: "Soft large color fields with a few sharp geometric cuts" },
  color_strategy: { "zh-tw": "從原圖提取2–4種低飽和主色，並保留一個鮮明強調色", en: "Pull 2–4 low-saturation primaries from the photo, keep one vivid accent" },
  aspect_ratio: { "zh-tw": "3:4", en: "3:4" },
  main_text: { "zh-tw": "根據原圖內容生成2–6字的簡約短語", en: "Generate a 2–6 character spare phrase from the photo" },
  supporting_text: { "zh-tw": "根據畫面生成一句剋制、具體的記憶描述，也可以省略", en: "A restrained, specific memory line from the picture, or omit" },
  text_language: { "zh-tw": "跟隨使用者使用的語言", en: "Follow the user's language" },
  display_mode: { "zh-tw": "原圖在上，抽象色塊轉譯在下", en: "Photo on top, abstract translation below" },
  exhibition_theme: { "zh-tw": "根據照片生成2–8字的含蓄主題", en: "A 2–8 character understated theme from the photo" },
  description: { "zh-tw": "根據畫面真實內容生成一句簡短描述", en: "One short caption from what the picture actually shows" },
  translation_mode: { "zh-tw": "抽象重製", en: "Abstract remake" },
  translation_focus: { "zh-tw": "自動選擇3–5個最具識別度的元素", en: "Auto-select 3–5 of the most recognizable elements" },
  serial_code: { "zh-tw": "NO. 02", en: "NO. 02" },
  album_title: { "zh-tw": "根據圖像核心生成2–5個英文單詞", en: "2–5 English words from the image’s core" },
  album_note: { "zh-tw": "根據畫面生成一句簡短英文描述", en: "One short English line from the picture" },
  catalog_code: { "zh-tw": "自動生成簡潔的虛構編號", en: "Auto-generate a short fictional catalog code" },
  cover_style: { "zh-tw": "70年代現代主義專輯設計", en: "1970s modernist album design" }
};
